...
| 🧭 | [**Chromium_wx64**](https://github.com/Chidaruma696/Chromium_wx64) | Mis compilaciones estables de Chromium para Windows x64: Google Sync con mis claves de API, códecs propietarios, HEVC, Widevine, build oficial con ThinLTO y PGO, compilado para CPU con AVX2. Misma receta que las builds de Hibbiki | C++ · GN · clang-cl |
...
- **Anime, manga, Touhou y Linux.** Son el origen de la mayoría de estos proyectos y de su estética. Touhou Project y sus personajes (Reimu, Sanae, Satori, Patchouli y los nombres de las paletas) pertenecen a Team Shanghai Alice (ZUN); los proyectos que llevan sus nombres son obras de fans no oficiales, hechas según sus directrices para obras derivadas, sin afiliación ni respaldo.
