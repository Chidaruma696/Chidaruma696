...
| ⛩️ | [**Reimu**](https://github.com/Chidaruma696/Reimu) · *experimental* | Instalador de Arch Linux en Bash: hace las preguntas correctas (sistema de archivos, swap, cifrado, bootloader, escritorio) y termina el trabajo en una sola pasada: LUKS2, snapshots btrfs, systemd-boot o GRUB, drivers, AUR, paquetes de software, configuraciones repetibles | Bash · ISO de Arch |
| 🌿 | [**Sanae**](https://github.com/Chidaruma696/Sanae) · *experimental* | Tienda de software para Arch Linux que vive en la terminal: estantes de AppStream con nombres humanos y popularidad, repositorios y AUR en una sola búsqueda, actualizaciones con las noticias de Arch, cola con vista previa, y recetas que instalan y configuran (Docker, QEMU, fuentes, temas de XFCE). Reimu ofrece instalarla al terminar | Rust · ratatui · pacman |
