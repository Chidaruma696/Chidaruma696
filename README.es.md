...
| 🧭 | [**Chromium_wx64**](https://github.com/Chidaruma696/Chromium_wx64) | Mis compilaciones estables de Chromium para Windows x64: Google Sync con mis claves de API, códecs propietarios, HEVC, Widevine, build oficial con ThinLTO y PGO, compilado para CPU con AVX2 | C++ · GN · clang-cl |
