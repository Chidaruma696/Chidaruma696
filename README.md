...
| 🧭 | [**Chromium_wx64**](https://github.com/Chidaruma696/Chromium_wx64) | My own stable Chromium builds for Windows x64: Google Sync with my API keys, proprietary codecs, HEVC, Widevine, official build with ThinLTO and PGO, compiled for AVX2 CPUs. Same recipe as Hibbiki's builds | C++ · GN · clang-cl |
